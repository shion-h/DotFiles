...
-- mytextclock = awful.widget.textclock({ align = "right",format = " %a %b %d, %H:%M:%S", timeout = 10 })
...
for s = 1, screen.count() do
   ...
   -- Widgets that are aligned to the bottom
    ...
    bottom_layout:add(spacer)
    bottom_layout:add(batterywidget)
    bottom_layout:add(spacer)
 ...
 -- Now bring it all together 
   ...
   -- Create the bottom wibox
     myinfowibox[s] = awful.wibox({ position = "left", screen = s })
   -- Widgets that are aligned to the bottom
 ...
 -- Now bring it all together 
    ...
    myinfowibox[s]:set_widget(left_layout)
end
-- }}}
